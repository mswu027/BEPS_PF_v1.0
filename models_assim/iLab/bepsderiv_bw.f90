...
!  Tapenade 3.16 (vossbeck01) -  7 Feb 2024 11:44
!
!  Differentiation of cos_plant in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstyp
!e bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of fominef_ss in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepsty
!pe bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of maxx in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype bep
!stypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!*********************Climate Forcing datasets**********************
  TYPE, PUBLIC :: FORC
      ...
      CHARACTER(len=10) :: meteo_ref_yyyymmdd=''
      INTEGER :: meteo_ref_time(4)
  END TYPE FORC
...
!******************for boundary/yrdata/lai/cpools/
  TYPE, PUBLIC :: SURF
      ...
      CHARACTER(len=10) :: lai_ref_yyyymmdd=''
      INTEGER :: lai_ref_time(4)
  END TYPE SURF
! boundary conditions
...
! save
  PUBLIC :: initbepstype
  PUBLIC :: initbepstype_fwd, initbepstype_bwd
  PRIVATE :: initatm2lnd
  PRIVATE :: initsurf
  PRIVATE :: initouput
  PRIVATE :: initouput_fwd, initouput_bwd
  PRIVATE :: initassim
  PRIVATE :: initassim_fwd, initassim_bwd

CONTAINS
!  Differentiation of initbepstype in reverse (adjoint) mode, forward sweep (with options noinclude noISIZE r8 split(initf bepsty
!peinit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: v2last:out assim.p_vcmax:out assim.p_vj_slope:out
...
!                output.sifpft:out output.sif:out output.thetampft:out
!                output.thetam:out output.cos_fluxpft:out output.cos_flux:out
  SUBROUTINE INITBEPSTYPE_FWD()
    IMPLICIT NONE
    ...
    CALL INITATM2LND()
    CALL INITSURF()
    CALL INITSOILSTAT_FWD()
    CALL INITOUPUT_FWD()
    CALL INITASSIM_FWD()
  END SUBROUTINE INITBEPSTYPE_FWD

!  Differentiation of initbepstype in reverse (adjoint) mode, backward sweep (with options noinclude noISIZE r8 split(initf bepst
!ypeinit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: v2last:out assim.p_vcmax:out assim.p_vj_slope:out
!                assim.p_sif_alpha:out assim.p_sif_beta:out assim.p_ksat_scalar:out
!                assim.p_b_scalar:out assim.p_f_leaf:out soilstat.zp:out
!                soilstat.zsp:out soilstat.r_rain_g:out soilstat.r_drainage:out
...
!                output.sifpft:out output.sif:out output.thetampft:out
!                output.thetam:out output.cos_fluxpft:out output.cos_flux:out
  SUBROUTINE INITBEPSTYPE_BWD()
    IMPLICIT NONE
    CALL INITASSIM_BWD()
    CALL INITOUPUT_BWD()
    CALL INITSOILSTAT_BWD()
    DEALLOCATE(v2last)
    DEALLOCATE(v2last_bw)
  END SUBROUTINE INITBEPSTYPE_BWD
...
!  Differentiation of initassim in reverse (adjoint) mode, forward sweep (with options noinclude noISIZE r8 split(initf bepstypei
!nit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: assim.p_vcmax:out assim.p_vj_slope:out
!                assim.p_sif_alpha:out assim.p_sif_beta:out assim.p_ksat_scalar:out
!                assim.p_b_scalar:out assim.p_f_leaf:out
  SUBROUTINE INITASSIM_FWD()
    IMPLICIT NONE
!--iLab::avoid pointer
! type(para),pointer  ::p
! p => assim
...
!assim%p_f_lr   = 0.
    ...
    assim%u_b_scalar = 0.
!assim%u_f_lr   = 0.
  END SUBROUTINE INITASSIM_FWD

!  Differentiation of initassim in reverse (adjoint) mode, backward sweep (with options noinclude noISIZE r8 split(initf bepstype
!init.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: assim.p_vcmax:out assim.p_vj_slope:out
!                assim.p_sif_alpha:out assim.p_sif_beta:out assim.p_ksat_scalar:out
!                assim.p_b_scalar:out assim.p_f_leaf:out
  SUBROUTINE INITASSIM_BWD()
    IMPLICIT NONE
    DEALLOCATE(assim%u_agb2vod)
    DEALLOCATE(assim%u_tau25)
    DEALLOCATE(assim%u_ko25)
    DEALLOCATE(assim%u_kc25)
    DEALLOCATE(assim%u_f_leaf)
    DEALLOCATE(assim%u_b_scalar)
    DEALLOCATE(assim%u_ksat_scalar)
    DEALLOCATE(assim%u_d0)
    DEALLOCATE(assim%u_taweff)
    DEALLOCATE(assim%u_sif_beta)
    DEALLOCATE(assim%u_sif_alpha)
    DEALLOCATE(assim%u_vj_slope)
    DEALLOCATE(assim%u_q10)
    DEALLOCATE(assim%u_vcmax)
    DEALLOCATE(assim%p_agb2vod)
    DEALLOCATE(assim%p_tau25)
    DEALLOCATE(assim%p_ko25)
    DEALLOCATE(assim%p_kc25)
    DEALLOCATE(assim%p_f_leaf)
    DEALLOCATE(assim_bw%p_f_leaf)
    DEALLOCATE(assim%p_b_scalar)
    DEALLOCATE(assim_bw%p_b_scalar)
    DEALLOCATE(assim%p_ksat_scalar)
    DEALLOCATE(assim_bw%p_ksat_scalar)
    DEALLOCATE(assim%p_d0)
    DEALLOCATE(assim%p_taweff)
    DEALLOCATE(assim%p_sif_beta)
    DEALLOCATE(assim_bw%p_sif_beta)
    DEALLOCATE(assim%p_sif_alpha)
    DEALLOCATE(assim_bw%p_sif_alpha)
    DEALLOCATE(assim%p_vj_slope)
    DEALLOCATE(assim_bw%p_vj_slope)
    DEALLOCATE(assim%p_q10)
    DEALLOCATE(assim%p_vcmax)
    DEALLOCATE(assim_bw%p_vcmax)
  END SUBROUTINE INITASSIM_BWD
...
!  Differentiation of initsoilstat in reverse (adjoint) mode, forward sweep (with options noinclude noISIZE r8 split(initf bepsty
!peinit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
! p => soilstat
    ...
    soilstat%ett(:, :, :) = 0.
    soilstat%g(:, :, :) = 0.
  END SUBROUTINE INITSOILSTAT_FWD

!  Differentiation of initsoilstat in reverse (adjoint) mode, backward sweep (with options noinclude noISIZE r8 split(initf bepst
!ypeinit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: soilstat.zp:out soilstat.zsp:out
!                soilstat.r_rain_g:out soilstat.r_drainage:out
!                soilstat.r_root_decay:out soilstat.psi_min:out
...
!                soilstat.kb:out soilstat.kk:out soilstat.cs:out
!                soilstat.lambda:out soilstat.ett:out soilstat.g:out
  SUBROUTINE INITSOILSTAT_BWD()
    IMPLICIT NONE
    DEALLOCATE(soilstat%g)
    DEALLOCATE(soilstat_bw%g)
    DEALLOCATE(soilstat%ett)
    DEALLOCATE(soilstat_bw%ett)
    DEALLOCATE(soilstat%lambda)
    DEALLOCATE(soilstat_bw%lambda)
    DEALLOCATE(soilstat%cs)
    DEALLOCATE(soilstat_bw%cs)
    DEALLOCATE(soilstat%kk)
    DEALLOCATE(soilstat_bw%kk)
    DEALLOCATE(soilstat%kb)
    DEALLOCATE(soilstat_bw%kb)
    DEALLOCATE(soilstat%km)
    DEALLOCATE(soilstat_bw%km)
    DEALLOCATE(soilstat%r_waterflow)
    DEALLOCATE(soilstat_bw%r_waterflow)
    DEALLOCATE(soilstat%psib)
    DEALLOCATE(soilstat_bw%psib)
    DEALLOCATE(soilstat%thetab)
    DEALLOCATE(soilstat_bw%thetab)
    DEALLOCATE(soilstat%psim)
    DEALLOCATE(soilstat_bw%psim)
    DEALLOCATE(soilstat%f_ice)
    DEALLOCATE(soilstat_bw%f_ice)
    DEALLOCATE(soilstat%temp_soil_c)
    DEALLOCATE(soilstat_bw%temp_soil_c)
    DEALLOCATE(soilstat%temp_soil_p)
    DEALLOCATE(soilstat_bw%temp_soil_p)
    DEALLOCATE(soilstat%thetam_prev)
    DEALLOCATE(soilstat_bw%thetam_prev)
    DEALLOCATE(soilstat%thetam)
    DEALLOCATE(soilstat_bw%thetam)
    DEALLOCATE(soilstat%ice_ratio)
    DEALLOCATE(soilstat_bw%ice_ratio)
    DEALLOCATE(soilstat%f_org)
    DEALLOCATE(soilstat_bw%f_org)
    DEALLOCATE(soilstat%density_soil)
    DEALLOCATE(soilstat_bw%density_soil)
    DEALLOCATE(soilstat%b)
    DEALLOCATE(soilstat_bw%b)
    DEALLOCATE(soilstat%psi_sat)
    DEALLOCATE(soilstat_bw%psi_sat)
    DEALLOCATE(soilstat%ksat)
    DEALLOCATE(soilstat_bw%ksat)
    DEALLOCATE(soilstat%fei)
    DEALLOCATE(soilstat_bw%fei)
    DEALLOCATE(soilstat%theta_vwp)
    DEALLOCATE(soilstat_bw%theta_vwp)
    DEALLOCATE(soilstat%theta_vfc)
    DEALLOCATE(soilstat_bw%theta_vfc)
    DEALLOCATE(soilstat%thermal_cond)
    DEALLOCATE(soilstat_bw%thermal_cond)
    DEALLOCATE(soilstat%dt)
    DEALLOCATE(soilstat_bw%dt)
    DEALLOCATE(soilstat%f_root)
    DEALLOCATE(soilstat_bw%f_root)
    DEALLOCATE(soilstat%d_soil)
    DEALLOCATE(soilstat_bw%d_soil)
    DEALLOCATE(soilstat%f_soilwater)
    DEALLOCATE(soilstat_bw%f_soilwater)
    DEALLOCATE(soilstat%alpha)
    DEALLOCATE(soilstat_bw%alpha)
    DEALLOCATE(soilstat%psi_min)
    DEALLOCATE(soilstat_bw%psi_min)
    DEALLOCATE(soilstat%r_root_decay)
    DEALLOCATE(soilstat_bw%r_root_decay)
    DEALLOCATE(soilstat%r_drainage)
    DEALLOCATE(soilstat_bw%r_drainage)
    DEALLOCATE(soilstat%r_rain_g)
    DEALLOCATE(soilstat_bw%r_rain_g)
    DEALLOCATE(soilstat%zsp)
    DEALLOCATE(soilstat_bw%zsp)
    DEALLOCATE(soilstat%zp)
    DEALLOCATE(soilstat_bw%zp)
    DEALLOCATE(soilstat%n_layer)
    DEALLOCATE(soilstat_bw%n_layer)
  END SUBROUTINE INITSOILSTAT_BWD
...
!  Differentiation of initouput in reverse (adjoint) mode, forward sweep (with options noinclude noISIZE r8 split(initf bepstypei
!nit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: output.sifpft:out output.sif:out
!                output.thetampft:out output.thetam:out output.cos_fluxpft:out
!                output.cos_flux:out
  SUBROUTINE INITOUPUT_FWD()
    IMPLICIT NONE
!--iLab::avoid pointer
! type(res),pointer::p
! p=>output
    ALLOCATE(output_bw%gpppft(npoints, pft))
    output_bw%gpppft = 0.0_8
    ...
    output%cos_flux(:) = 0.
    output%vod(:) = 0.
  END SUBROUTINE INITOUPUT_FWD

!  Differentiation of initouput in reverse (adjoint) mode, backward sweep (with options noinclude noISIZE r8 split(initf bepstype
!init.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: output.sifpft:out output.sif:out
!                output.thetampft:out output.thetam:out output.cos_fluxpft:out
!                output.cos_flux:out
  SUBROUTINE INITOUPUT_BWD()
    IMPLICIT NONE
    DEALLOCATE(output%npp_yr_acc)
    DEALLOCATE(output%cos_flux)
    DEALLOCATE(output_bw%cos_flux)
    DEALLOCATE(output%cos_fluxpft)
    DEALLOCATE(output_bw%cos_fluxpft)
    DEALLOCATE(output%vod)
    DEALLOCATE(output%vodpft)
    DEALLOCATE(output_bw%vodpft)
    DEALLOCATE(output%fapar)
    DEALLOCATE(output%faparpft)
    DEALLOCATE(output_bw%faparpft)
    DEALLOCATE(output%thetam)
    DEALLOCATE(output_bw%thetam)
    DEALLOCATE(output%thetampft)
    DEALLOCATE(output_bw%thetampft)
    DEALLOCATE(output%net_rad)
    DEALLOCATE(output%evap)
    DEALLOCATE(output%trans)
    DEALLOCATE(output%lh)
    DEALLOCATE(output%sh)
    DEALLOCATE(output%lai)
    DEALLOCATE(output%laipft)
    DEALLOCATE(output_bw%laipft)
    DEALLOCATE(output%nep)
    DEALLOCATE(output%npp)
    DEALLOCATE(output%sif_sat)
    DEALLOCATE(output%sif)
    DEALLOCATE(output_bw%sif)
    DEALLOCATE(output%gpp)
    DEALLOCATE(output%net_radpft)
    DEALLOCATE(output_bw%net_radpft)
    DEALLOCATE(output%evappft)
    DEALLOCATE(output_bw%evappft)
    DEALLOCATE(output%transpft)
    DEALLOCATE(output_bw%transpft)
    DEALLOCATE(output%lhpft)
    DEALLOCATE(output_bw%lhpft)
    DEALLOCATE(output%shpft)
    DEALLOCATE(output_bw%shpft)
    DEALLOCATE(output%neppft)
    DEALLOCATE(output_bw%neppft)
    DEALLOCATE(output%npppft)
    DEALLOCATE(output_bw%npppft)
    DEALLOCATE(output%sifpft_sat)
    DEALLOCATE(output_bw%sifpft_sat)
    DEALLOCATE(output%sifpft)
    DEALLOCATE(output_bw%sifpft)
    DEALLOCATE(output%gpppft)
    DEALLOCATE(output_bw%gpppft)
  END SUBROUTINE INITOUPUT_BWD
...
!call mpi_barrier(mpi_comm_world,ierr)
  ...
  SUBROUTINE READ_METEO_SITE_REFTIME(yr, mn, dy)
    IMPLICIT NONE
!-- arguments
...
&     'hours since YYYY-MM-DD'
    ...
    INTEGER :: result1
    ldebug = .false.
    IF (clim%meteo_ref_yyyymmdd .NE. '') THEN
      yr = clim%meteo_ref_time(1)
      mn = clim%meteo_ref_time(2)
      dy = clim%meteo_ref_time(3)
    ELSE IF (LEN(TRIM(beps_site_path)) + LEN(TRIM(meteo_site_flnm_prefix&
...
&                 ':reading meteo data ***'//TRIM(fname)//'***'
      result1 = NF90_OPEN(fname, nf90_nowrite, ncid)
      CALL CHECK(result1)
      result1 = NF90_INQ_VARID(ncid, dsname, timevar_id)
      CALL CHECK(result1)
      IF (ldebug) WRITE(*, '(a)') 'DEBUG::'//method//&
...
&       time_unit)//'***'
        STOP
      ELSE IF (time_unit(1:11) .NE. 'hours since') THEN
        WRITE(*, '(a)') ' FATAL::'//method//&
&       ': unexpected unit of dataset -->'//dsname//'<--'//&
&       ' in file ***'//TRIM(fname)//'*** '//'expected='//TRIM(&
&       time_unit_expected)//', found='//TRIM(time_unit)
        STOP
      ELSE
...
!
!-- store also as integer values (and return)
!
        CALL YYYYMMDD_DASHED_YRMNDY(clim%meteo_ref_yyyymmdd, yr, mn, dy)
        clim%meteo_ref_time = 0
        clim%meteo_ref_time(1:3) = (/yr, mn, dy/)
      END IF
    END IF
...
!call mpi_barrier(mpi_comm_world,ierr)
  ...
  SUBROUTINE READ_LAI_SITE_REFTIME(yr, mn, dy)
    IMPLICIT NONE
!-- arguments
    INTEGER, INTENT(OUT) :: yr, mn, dy
!-- local
    ...
    LOGICAL :: ldebug
    CHARACTER(len=255) :: fname
    CHARACTER(len=*), PARAMETER :: method='read_lai_site_reftime'
    CHARACTER(len=*), PARAMETER :: dsname='time'
    CHARACTER(len=*), PARAMETER :: time_unit_expected=&
&     'days since YYYY-MM-DD'
    CHARACTER(len=128) :: time_unit
    ...
    INTEGER :: result1
    ldebug = .false.
    IF (bound%lai_ref_yyyymmdd .NE. '') THEN
      yr = bound%lai_ref_time(1)
      mn = bound%lai_ref_time(2)
      dy = bound%lai_ref_time(3)
    ELSE IF (LEN(TRIM(beps_site_path)) + LEN(TRIM(beps_lai_site_prefix))&
&       + LEN('.nc') .GT. LEN(fname)) THEN
      WRITE(*, '(a)') 'FATAL::INTERNAL-ERROR::'//method//&
&     ':file name too long!'
      STOP
    ELSE
      fname = TRIM(beps_site_path)//'/'//TRIM(beps_lai_site_prefix)//&
&       '.nc'
      IF (ldebug) WRITE(*, '(a)') 'DEBUG::'//method//&
&                 ':reading LAI reference time ***'//TRIM(fname)//'***'
      result1 = NF90_OPEN(fname, nf90_nowrite, ncid)
      CALL CHECK(result1)
      result1 = NF90_INQ_VARID(ncid, dsname, timevar_id)
      CALL CHECK(result1)
      IF (ldebug) WRITE(*, '(a)') 'DEBUG::'//method//&
&                 ':data set identifier determined!'
!-- iLab::get reference time in LAI forcing
      result1 = NF90_GET_ATT(ncid, timevar_id, 'units', time_unit)
      CALL CHECK(result1)
      IF (LEN(TRIM(time_unit)) .NE. LEN(time_unit_expected)) THEN
        WRITE(*, '(a)') ' FATAL::'//method//&
...
&       time_unit_expected)//', found='//TRIM(time_unit)
        STOP
      ELSE IF (time_unit(1:10) .NE. 'days since') THEN
        WRITE(*, '(a)') ' FATAL::'//method//&
&       ': unexpected unit of dataset -->'//dsname//'<--'//&
&       ' in file ***'//TRIM(fname)//'*** '//'expected='//TRIM(&
&       time_unit_expected)//', found='//TRIM(time_unit)
        STOP
      ELSE
!-- expected: "days since yyyy-mm-dd"
!             "123456789012345678901"
!                         !        !
        bound%lai_ref_yyyymmdd(1:10) = time_unit(12:21)
        result1 = NF90_CLOSE(ncid)
        CALL CHECK(result1)
        IF (ldebug) WRITE(*, '(a)') 'DEBUG::'//method//&
&                   ':NetCDF file closed again.'
...
!-- store also as integer values (and return)
!
        CALL YYYYMMDD_DASHED_YRMNDY(bound%lai_ref_yyyymmdd, yr, mn, dy)
        bound%lai_ref_time = 0
        bound%lai_ref_time(1:3) = (/yr, mn, dy/)
      END IF
    END IF
  END SUBROUTINE READ_LAI_SITE_REFTIME
...
!***********************************************************
!     yyyymmdd_dashed_yrmndy
!
!> @brief extract year/mon/date as integer values
!         from dashed date string yyyy-mm-dd
!
!> @comment since this is a generic utility routine
!           it should eventually be moved to a separate module
!
!> \authors Michael Vossbeck, The Inversion Lab
!> \date    May 2024
!> \last    May 2024
  SUBROUTINE YYYYMMDD_DASHED_YRMNDY(yyyymmdd_dashed, yr, mn, dy)
    IMPLICIT NONE
!-- arguments
!-- dashed date string, formatted as yyyy-mm-dd
    CHARACTER(len=*), INTENT(IN) :: yyyymmdd_dashed
    INTEGER, INTENT(OUT) :: yr, mn, dy
!-- local
    CHARACTER(len=*), PARAMETER :: method='yyyymmdd_dashed_yrmndy'
    INTEGER :: iostat
!-- extract year/month/day from date string
    CALL STR2INT(yyyymmdd_dashed(1:4), yr, iostat)
    IF (iostat .NE. 0) THEN
      WRITE(*, '(a)') 'FATAL::'//method//':: -->'//yyyymmdd_dashed(1:4)&
&     //'<-- not parsed to integer'
      STOP
    ELSE
      CALL STR2INT(yyyymmdd_dashed(6:7), mn, iostat)
      IF (iostat .NE. 0) THEN
        WRITE(*, '(a)') 'FATAL::'//method//':: -->'//yyyymmdd_dashed(6:7&
&       )//'<-- not parsed to integer'
        STOP
      ELSE
        CALL STR2INT(yyyymmdd_dashed(9:10), dy, iostat)
        IF (iostat .NE. 0) THEN
          WRITE(*, '(a)') 'FATAL::'//method//':: -->'//yyyymmdd_dashed(9&
&         :10)//'<-- not parsed to integer'
          STOP
        END IF
      END IF
    END IF
...
!-- arguments
  ...
  END SUBROUTINE YYYYMMDD_DASHED_YRMNDY
...
CONTAINS
!  Differentiation of meteo_pack in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepsty
!pe bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
CONTAINS
!  Differentiation of lai_cal in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype 
!bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of vcmax_jmax in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepsty
!pe bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of leaf_temperatures in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.ini
!tbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of leaf_temperature in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.init
!bepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of transpiration in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbep
!stype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of evaporation_canopy in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.in
!itbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of photosynthesis in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbe
!pstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
! call cos_plant(LC,cosii,convf,gs_h2o_mole,g_lb_cos,vcmax,ffpa,f_soilwater,cos_assim)
    CALL PUSHREAL8(cos_assim)
    CALL PUSHREAL8(g_lb_cos)
    CALL PUSHREAL8(gs_h2o_mole)
...
! ppb
    ...
    CALL POPREAL8(gs_h2o_mole)
    CALL POPREAL8(g_lb_cos)
    CALL POPREAL8(cos_assim)
...
&       + 2*p_cubic*qroot_bw/9.0
      ...
      r_cubic_bw = 27.0*temp_bw13
      denom = e_ps*alpha_ps
      CALL POPREAL8(r_cubic)
      CALL POPREAL8(q_cubic)
      CALL POPREAL8(p_cubic)
...
!  Differentiation of sfc_vpd in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype 
!bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of temp_func in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstyp
!e bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: y
...
!  Differentiation of lambda in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype b
!epstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of tboltz in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype b
!epstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of tboltzc4 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype
! bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: y rate
!   with respect to varying inputs: rate
...
CONTAINS
!  Differentiation of init_soil_parameters in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.
!initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of init_soil_status in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.init
!bepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of surfacetemperature in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.in
!itbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of updateheatflux in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbe
!pstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: p.ice_ratio p.thetam p.thetam_prev
...
&         depth_f+p%d_soil(i-1)*0.5)
    ...
    END DO
    DO i=0,p%n_layer-1
      CALL PUSHREAL8(p%temp_soil_c(i))
...
!  Differentiation of update_cs in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstyp
!e bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of update_ice_ratio in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.init
!bepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: p.ice_ratio p.thetam p.thetam_prev
!                p.temp_soil_c p.cs
!   with respect to varying inputs: p.ice_ratio p.thetam p.thetam_prev
...
!  Differentiation of updatesoilthermalconductivity in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf beps
!typeinit.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of updatesoilmoisture in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.in
!itbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!save previous thetam
      CALL PUSHREAL8(p%thetam_prev(i))
...
!  Differentiation of soil_water_uptake in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.ini
!tbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of soil_water_factor_v2 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.
!initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of soil_evaporation in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.init
!bepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
CONTAINS
!  Differentiation of rainfall_stage1 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initb
!epstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of rainfall_stage2 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initb
!epstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of snowpack_stage1 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initb
!epstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of snowpack_stage2 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initb
!epstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of snowpack_stage3 in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initb
!epstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
CONTAINS
!  Differentiation of restart_io in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepsty
!pe bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: *v2last
!   with respect to varying inputs: *v2last
!   Plus diff mem management of: v2last:in
  SUBROUTINE RESTART_IO_BW(flag, yy, mm, dd, tod)
    IMPLICIT NONE
    CHARACTER(len=*) :: flag
...
!  Differentiation of cost in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype bep
!stypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: f
!   with respect to varying inputs: f x
!   RW status of diff variables: e_actual[from module meteomod]:(loc)
!                cp_air[from module meteomod]:(loc) e_saturate[from module meteomod]:(loc)
!                sp_humidity[from module meteomod]:(loc) vpd[from module meteomod]:(loc)
!                slope_vapor[from module meteomod]:(loc) bound_layer_res.vapor[from module angsmod]:(loc)
!                fact.latent[from module angsmod]:(loc) f:in-zero
!                x:out
!   Plus diff mem management of: v2last[save in bepstype]:in assim.p_vcmax[save in bepstype]:in
!                assim.p_vj_slope[save in bepstype]:in assim.p_sif_alpha[save in bepstype]:in
!                assim.p_sif_beta[save in bepstype]:in assim.p_ksat_scalar[save in bepstype]:in
!                assim.p_b_scalar[save in bepstype]:in assim.p_f_leaf[save in bepstype]:in
!                soilstat.zp[save in bepstype]:in soilstat.zsp[save in bepstype]:in
!                soilstat.r_rain_g[save in bepstype]:in soilstat.r_drainage[save in bepstype]:in
!                soilstat.r_root_decay[save in bepstype]:in soilstat.psi_min[save in bepstype]:in
!                soilstat.alpha[save in bepstype]:in soilstat.f_soilwater[save in bepstype]:in
!                soilstat.d_soil[save in bepstype]:in soilstat.f_root[save in bepstype]:in
!                soilstat.dt[save in bepstype]:in soilstat.thermal_cond[save in bepstype]:in
!                soilstat.theta_vfc[save in bepstype]:in soilstat.theta_vwp[save in bepstype]:in
!                soilstat.fei[save in bepstype]:in soilstat.ksat[save in bepstype]:in
!                soilstat.psi_sat[save in bepstype]:in soilstat.b[save in bepstype]:in
!                soilstat.density_soil[save in bepstype]:in soilstat.f_org[save in bepstype]:in
!                soilstat.ice_ratio[save in bepstype]:in soilstat.thetam[save in bepstype]:in
!                soilstat.thetam_prev[save in bepstype]:in soilstat.temp_soil_p[save in bepstype]:in
!                soilstat.temp_soil_c[save in bepstype]:in soilstat.f_ice[save in bepstype]:in
!                soilstat.psim[save in bepstype]:in soilstat.thetab[save in bepstype]:in
!                soilstat.psib[save in bepstype]:in soilstat.r_waterflow[save in bepstype]:in
!                soilstat.km[save in bepstype]:in soilstat.kb[save in bepstype]:in
!                soilstat.kk[save in bepstype]:in soilstat.cs[save in bepstype]:in
!                soilstat.lambda[save in bepstype]:in soilstat.ett[save in bepstype]:in
!                soilstat.g[save in bepstype]:in output.sifpft[save in bepstype]:in
!                output.sif[save in bepstype]:in output.thetampft[save in bepstype]:in
!                output.thetam[save in bepstype]:in output.cos_fluxpft[save in bepstype]:in
!                output.cos_flux[save in bepstype]:in
...
!  Differentiation of misfit in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype b
!epstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!> \authors Michael Vossbeck, The Inversion Lab
!> \date    June 2022
SUBROUTINE NCWRITEOBS_CD(m, yobs, syobs)
  USE OBS_NETCDF
  USE MO_BEPSFUNC_CTL
  USE BEPSTYPE_DIFF, ONLY : bound
...
!-- file to be generated
  CHARACTER(len=*), PARAMETER :: outname='obs.nc'
!-- year,month,day,hour
  INTEGER, PARAMETER :: ntc=4
!-- gzip-like compression level
  INTEGER, PARAMETER :: zlev=4
!-- 2MB [bytes]
  INTEGER, PARAMETER :: chunklim=2*1000000
  REAL(kind=8), ALLOCATABLE :: data3d(:, :, :), dataunc3d(:, :, :)
!-- NetCDF stuff
  INTEGER :: ncid, rc
  INTEGER :: dimid_nlp, dimid_time, dimid_ntc
  INTEGER :: varid
!-- for data variables only dimensioned with (nlp,ntp)
  INTEGER :: var_chunksizes(2)
  INTEGER :: chunk_ntp
!--
  LOGICAL, SAVE :: ldebug=.false.
  INTRINSIC RESHAPE
  ...
  INTEGER :: result1
!-- basic consistency
  IF (m .NE. nsimvar*ntp*nlp) WRITE(*, '(a,2(a,i6,1x))') ' FATAL::'//sub&
&                             //&
&                            ': unexpected size of observation vector, '&
&                             , 'expected=', nsimvar*ntp*nlp, 'got=', m
  ALLOCATE(data3d(nsimvar, nlp, ntp))
  ALLOCATE(dataunc3d(nsimvar, nlp, ntp))
...
!-- open file
  ...
  CALL NC_CHECK(rc)
  IF (ldebug) WRITE(*, '(a)') ' DEBUG::'//sub//&
&             ': opened for writing ***'//TRIM(outname)//'***'
!-- define dimensions
  result1 = NF90_DEF_DIM(ncid, 'nlp', nlp, dimid_nlp)
  CALL NC_CHECK(result1)
  result1 = NF90_DEF_DIM(ncid, 'time', ntp, dimid_time)
  CALL NC_CHECK(result1)
!yyyymmdd
  result1 = NF90_DEF_DIM(ncid, 'ntc', ntc, dimid_ntc)
  CALL NC_CHECK(result1)
!-- dimension variables
!>> calendar
  result1 = NF90_DEF_VAR(ncid, 'yyyymmddss', nf90_int, (/dimid_ntc, &
&   dimid_time/), varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'comment', &
&   'year/month/day/time-of-day[s]')
  CALL NC_CHECK(result1)
!>> longitude
  result1 = NF90_DEF_VAR(ncid, 'lon', nf90_double, (/dimid_nlp/), varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', 'longitude')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'units', 'degrees_east')
  CALL NC_CHECK(result1)
!>> latitude
  result1 = NF90_DEF_VAR(ncid, 'lat', nf90_double, (/dimid_nlp/), varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', 'latitude')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'units', 'degrees_north')
  CALL NC_CHECK(result1)
!-- data variables
  IF (ntp*nlp*8 .GT. chunklim) THEN
!-- (nlp*8) because all variable data expected as kind=8.
    chunk_ntp = chunklim/(nlp*8)
  ELSE
    chunk_ntp = ntp
  END IF
  IF (ldebug) WRITE(*, '(a,2(a,i6,1x))') ' DEBUG::'//sub//&
&             ': chunksizes explicitly set to ', 'chunk_nlp=', nlp, &
&             'chunk_ntp=', chunk_ntp
!-- always *all* land points
  var_chunksizes = (/nlp, chunk_ntp/)
  IF (ldebug) WRITE(*, '(a,2(i6,1x))') ' DEBUG::'//sub//&
&             ': var_chunksizes = ', var_chunksizes(1), var_chunksizes(2&
&             )
!>> SIF
  result1 = NF90_DEF_VAR(ncid, 'sif', nf90_double, (/dimid_nlp, &
&   dimid_time/), varid, chunksizes=var_chunksizes, deflate_level=zlev, &
&   shuffle=.true.)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', &
&   'Solar induced fluorescence')
  ...
  CALL NC_CHECK(result1)
!>> SIF uncertainty
  result1 = NF90_DEF_VAR(ncid, 'sif_unc', nf90_double, (/dimid_nlp, &
&   dimid_time/), varid, chunksizes=var_chunksizes, deflate_level=zlev, &
&   shuffle=.true.)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', &
&   'Uncertainty of Solar induced fluorescence')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'units', 'mW/m2/nm/sr')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'missing_value', fill_value)
  CALL NC_CHECK(result1)
!>> Thetam
  result1 = NF90_DEF_VAR(ncid, 'sm', nf90_double, (/dimid_nlp, &
&   dimid_time/), varid, chunksizes=var_chunksizes, deflate_level=zlev, &
&   shuffle=.true.)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', &
&   'fractional surface layer soil moisture')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'units', '')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'missing_value', fill_value)
  CALL NC_CHECK(result1)
!>> Thetam uncertainty
  result1 = NF90_DEF_VAR(ncid, 'sm_unc', nf90_double, (/dimid_nlp, &
&   dimid_time/), varid, chunksizes=var_chunksizes, deflate_level=zlev, &
&   shuffle=.true.)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', &
&   'Uncertainty of fractional surface layer soil moisture')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'units', '')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'missing_value', fill_value)
  CALL NC_CHECK(result1)
!>> cosflux
  result1 = NF90_DEF_VAR(ncid, 'COS_flux', nf90_double, (/dimid_nlp, &
&   dimid_time/), varid, chunksizes=var_chunksizes, deflate_level=zlev, &
&   shuffle=.true.)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', &
&   'COS flux for soil and plant')
  ...
  CALL NC_CHECK(result1)
!>> cosflux uncertainty
  result1 = NF90_DEF_VAR(ncid, 'COS_flux_unc', nf90_double, (/dimid_nlp&
&   , dimid_time/), varid, chunksizes=var_chunksizes, deflate_level=zlev&
&   , shuffle=.true.)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'long_name', &
&   'Uncertainty of COS flux for soil and plant')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'units', 'pmol/m2/s')
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_ATT(ncid, varid, 'missing_value', fill_value)
...
!-- start writing
!>> calendar
  result1 = NF90_INQ_VARID(ncid, 'yyyymmddss', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, time_points(1:ntc, 1:ntp))
  CALL NC_CHECK(result1)
!>> longitude
  result1 = NF90_INQ_VARID(ncid, 'lon', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, bound%longitude(:))
  CALL NC_CHECK(result1)
!>> latitude
  result1 = NF90_INQ_VARID(ncid, 'lat', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, bound%latitude(:))
  CALL NC_CHECK(result1)
!>> SIF
  result1 = NF90_INQ_VARID(ncid, 'sif', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, data3d(1, :, :))
  CALL NC_CHECK(result1)
!>> SIF uncertainty
  result1 = NF90_INQ_VARID(ncid, 'sif_unc', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, dataunc3d(1, :, :))
  CALL NC_CHECK(result1)
!>> Thetam
  result1 = NF90_INQ_VARID(ncid, 'sm', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, data3d(2, :, :))
  CALL NC_CHECK(result1)
!>> Thetam uncertainty
  result1 = NF90_INQ_VARID(ncid, 'sm_unc', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, dataunc3d(2, :, :))
  CALL NC_CHECK(result1)
!>> COSflux
  result1 = NF90_INQ_VARID(ncid, 'COS_flux', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, data3d(3, :, :))
  CALL NC_CHECK(result1)
!>> COSflux uncertainty
  result1 = NF90_INQ_VARID(ncid, 'COS_flux_unc', varid)
  CALL NC_CHECK(result1)
  result1 = NF90_PUT_VAR(ncid, varid, dataunc3d(3, :, :))
  CALL NC_CHECK(result1)
...
!-- dispose memory
  DEALLOCATE(data3d)
  DEALLOCATE(dataunc3d)
END SUBROUTINE NCWRITEOBS_CD

!  Differentiation of devprior in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype
! bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of evalf_wrapper in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbep
!stype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: cost
!   with respect to varying inputs: pert cost
!   RW status of diff variables: e_actual[from module meteomod]:(loc)
!                cp_air[from module meteomod]:(loc) e_saturate[from module meteomod]:(loc)
!                sp_humidity[from module meteomod]:(loc) vpd[from module meteomod]:(loc)
!                slope_vapor[from module meteomod]:(loc) bound_layer_res.vapor[from module angsmod]:(loc)
!                fact.latent[from module angsmod]:(loc) pert:out
!                cost:in-zero
!   Plus diff mem management of: v2last[save in bepstype]:in-out
!                assim.p_vcmax[save in bepstype]:in-out assim.p_vj_slope[save in bepstype]:in-out
!                assim.p_sif_alpha[save in bepstype]:in-out assim.p_sif_beta[save in bepstype]:in-out
!                assim.p_ksat_scalar[save in bepstype]:in-out assim.p_b_scalar[save in bepstype]:in-out
!                assim.p_f_leaf[save in bepstype]:in-out soilstat.zp[save in bepstype]:in-out
!                soilstat.zsp[save in bepstype]:in-out soilstat.r_rain_g[save in bepstype]:in-out
!                soilstat.r_drainage[save in bepstype]:in-out soilstat.r_root_decay[save in bepstype]:in-out
!                soilstat.psi_min[save in bepstype]:in-out soilstat.alpha[save in bepstype]:in-out
!                soilstat.f_soilwater[save in bepstype]:in-out
!                soilstat.d_soil[save in bepstype]:in-out soilstat.f_root[save in bepstype]:in-out
!                soilstat.dt[save in bepstype]:in-out soilstat.thermal_cond[save in bepstype]:in-out
!                soilstat.theta_vfc[save in bepstype]:in-out soilstat.theta_vwp[save in bepstype]:in-out
!                soilstat.fei[save in bepstype]:in-out soilstat.ksat[save in bepstype]:in-out
!                soilstat.psi_sat[save in bepstype]:in-out soilstat.b[save in bepstype]:in-out
!                soilstat.density_soil[save in bepstype]:in-out
!                soilstat.f_org[save in bepstype]:in-out soilstat.ice_ratio[save in bepstype]:in-out
!                soilstat.thetam[save in bepstype]:in-out soilstat.thetam_prev[save in bepstype]:in-out
!                soilstat.temp_soil_p[save in bepstype]:in-out
!                soilstat.temp_soil_c[save in bepstype]:in-out
!                soilstat.f_ice[save in bepstype]:in-out soilstat.psim[save in bepstype]:in-out
!                soilstat.thetab[save in bepstype]:in-out soilstat.psib[save in bepstype]:in-out
!                soilstat.r_waterflow[save in bepstype]:in-out
!                soilstat.km[save in bepstype]:in-out soilstat.kb[save in bepstype]:in-out
!                soilstat.kk[save in bepstype]:in-out soilstat.cs[save in bepstype]:in-out
!                soilstat.lambda[save in bepstype]:in-out soilstat.ett[save in bepstype]:in-out
!                soilstat.g[save in bepstype]:in-out output.sifpft[save in bepstype]:in-out
!                output.sif[save in bepstype]:in-out output.thetampft[save in bepstype]:in-out
!                output.thetam[save in bepstype]:in-out output.cos_fluxpft[save in bepstype]:in-out
!                output.cos_flux[save in bepstype]:in-out

!  Differentiation of initf in reverse (adjoint) mode, backward sweep (with options noinclude noISIZE r8 split(initf bepstypeinit
!.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: v2last:out assim.p_vcmax:out assim.p_vj_slope:out
!                assim.p_sif_alpha:out assim.p_sif_beta:out assim.p_ksat_scalar:out
!                assim.p_b_scalar:out assim.p_f_leaf:out soilstat.zp:out
...
& get_curr_calday, get_nstep, get_start_date, timemgr_diff_secs
  ...
  INTEGER*4 :: branch
  CALL POPCONTROL1B(branch)
  CALL INITBEPSTYPE_BWD()
END SUBROUTINE INITF_BWD

!  Differentiation of initf in reverse (adjoint) mode, forward sweep (with options noinclude noISIZE r8 split(initf bepstypeinit.
!initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   Plus diff mem management of: v2last:out assim.p_vcmax:out assim.p_vj_slope:out
!                assim.p_sif_alpha:out assim.p_sif_beta:out assim.p_ksat_scalar:out
!                assim.p_b_scalar:out assim.p_f_leaf:out soilstat.zp:out
...
!- arguments
  INTEGER :: n, m
!-local variables
  CHARACTER(len=*), PARAMETER :: sub='initf_fwd::'
  LOGICAL :: ldebug
  CHARACTER(len=32) :: fmt
  INTRINSIC TRIM
  CHARACTER(len=4) :: result1
...
!  Differentiation of evalf in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype be
!pstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: x y
!   with respect to varying inputs: x
!   Plus diff mem management of: v2last:in assim.p_vcmax:in assim.p_vj_slope:in
!                assim.p_sif_alpha:in assim.p_sif_beta:in assim.p_ksat_scalar:in
!                assim.p_b_scalar:in assim.p_f_leaf:in soilstat.zp[save in bepstype]:in
!                soilstat.zsp[save in bepstype]:in soilstat.r_rain_g[save in bepstype]:in
!                soilstat.r_drainage[save in bepstype]:in soilstat.r_root_decay[save in bepstype]:in
!                soilstat.psi_min[save in bepstype]:in soilstat.alpha[save in bepstype]:in
!                soilstat.f_soilwater[save in bepstype]:in soilstat.d_soil[save in bepstype]:in
!                soilstat.f_root[save in bepstype]:in soilstat.dt[save in bepstype]:in
!                soilstat.thermal_cond[save in bepstype]:in soilstat.theta_vfc[save in bepstype]:in
!                soilstat.theta_vwp[save in bepstype]:in soilstat.fei[save in bepstype]:in
!                soilstat.ksat[save in bepstype]:in soilstat.psi_sat[save in bepstype]:in
!                soilstat.b[save in bepstype]:in soilstat.density_soil[save in bepstype]:in
!                soilstat.f_org[save in bepstype]:in soilstat.ice_ratio[save in bepstype]:in
!                soilstat.thetam[save in bepstype]:in soilstat.thetam_prev[save in bepstype]:in
!                soilstat.temp_soil_p[save in bepstype]:in soilstat.temp_soil_c[save in bepstype]:in
!                soilstat.f_ice[save in bepstype]:in soilstat.psim[save in bepstype]:in
!                soilstat.thetab[save in bepstype]:in soilstat.psib[save in bepstype]:in
!                soilstat.r_waterflow[save in bepstype]:in soilstat.km[save in bepstype]:in
!                soilstat.kb[save in bepstype]:in soilstat.kk[save in bepstype]:in
!                soilstat.cs[save in bepstype]:in soilstat.lambda[save in bepstype]:in
!                soilstat.ett[save in bepstype]:in soilstat.g[save in bepstype]:in
!                output.gpppft:in output.sifpft:in output.sifpft_sat:in
!                output.npppft:in output.neppft:in output.shpft:in
!                output.lhpft:in output.transpft:in output.evappft:in
!                output.net_radpft:in output.sif:in output.laipft:in
!                output.thetampft:in output.thetam:in output.faparpft:in
!                output.vodpft:in output.cos_fluxpft:in output.cos_flux:in
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!> \file bepsfunc.F90
...
& init_soil_parameters_bw, init_soil_status, init_soil_status_bw
  ...
  USE RESTART_DIFF, ONLY : v2last, v2last_bw, restart_io, restart_io_bw
  USE MO_BEPSFUNC_CTL
  IMPLICIT NONE
! arguments
...
!
  ...
  ELSE IF (lai_input .LT. 0) THEN
    STOP
  ELSE IF (m .NE. nsimvar*npoints*ntp) THEN
...
!--iLab::equations taken from beps_time_manager
      ...
      CALL PUSHREAL8(co2_air)
      CALL GET_CO2_CONCENTRATION(yr, co2_air)
      CALL PUSHREAL8(cos_air)
...
!         (tod will be zero, except the simulation had been started subdaily)
            CALL GET_NLAI_CD(yr, mn, dy, tod, n_lai)
...
!! retrieve meteo for this point
        CALL PUSHREAL8(meteo%srad)
        meteo%srad = clim%srad(i)
        CALL PUSHREAL8(meteo%wind)
        meteo%wind = clim%wind(i)
        CALL PUSHREAL8(meteo%rainfall)
        meteo%rainfall = clim%rain(i)
        CALL PUSHREAL8(meteo%snow)
        meteo%snow = clim%snow(i)
        CALL PUSHREAL8(meteo%rh)
        meteo%rh = clim%rh(i)
...
&           1.796*ratio_cloud**3+2.058*ratio_cloud**4)*meteo%srad
        ...
        CALL PUSHREAL8(meteo%s_dff)
        meteo%s_dff = shortrad_df
        CALL PUSHREAL8(meteo%s_dir)
...
! write(*,*) 'Ksat_old = ',soilp%Ksat(0)
              DO kk=0,4
                CALL PUSHREAL8(soilp%ksat(kk))
                soilp%ksat(kk) = assim%p_ksat_scalar(ii)*soilp%ksat(kk)
                CALL PUSHREAL8(soilp%b(kk))
...
!             end do
            ...
            CALL PUSHREAL8(soilp%r_drainage)
            CALL PUSHREAL8(soilp%psi_min)
            CALL PUSHREAL8(soilp%alpha)
...
!! end spatial loop
      END DO pointloop
      CALL PUSHBOOLEAN(is_end_curr_month)
!          call mpi_barrier(mpi_comm_world,ierr)
!! write out data and restart fields
      IF (enable_netcdf_out) THEN
        arg1 = nd + 1
        CALL AV_OUTPUT(yr, mn, dy, tod, arg1, is_end_curr_month, &
&                ref_date, seconds_since_ref(nd))
      END IF
      IF (write_restart) THEN
        IF (restart_frq .LT. 0) THEN
!! <0 ndays
! kount = get_nstep()
          kount = nd
          ...
          IF (MOD(kount, rst_nstep) .EQ. 0) CALL RESTART_IO('write', &
&                                                     yr_next, mn_next, &
&                                                     dy_next, tod_next)
        ELSE IF (restart_frq .EQ. 0) THEN
          yr_next = time_points(1, nd+1)
          mn_next = time_points(2, nd+1)
          dy_next = time_points(3, nd+1)
          tod_next = time_points(4, nd+1)
          IF (is_end_curr_month) CALL RESTART_IO('write', yr_next, &
&                                          mn_next, dy_next, tod_next)
        END IF
      END IF
    ...
    soilp_bw%g = 0.0_8
    DO nd=ntp,1,-1
      CALL POPBOOLEAN(is_end_curr_month)
      DO i=npoints,1,-1
...
&         i)
        ...
        DO 100 j=pft,1,-1
          CALL POPCONTROL2B(branch)
          IF (branch .NE. 0) THEN
            IF (branch .NE. 1) GOTO 100
          END IF
          temp_bw = bound%pct_pft(i, j)*output_bw%cos_fluxpft(i, j)/100.
...
&           100.
          ...
          CALL POPREAL8(soilp%alpha)
          CALL POPREAL8(soilp%psi_min)
          CALL POPREAL8(soilp%r_drainage)
...
&                     bound%lcno(i, j), bound%clumping(i), assim%p_vcmax&
&                     (j), assim_bw%p_vcmax(j), assim%p_vj_slope(j), &
&                     assim_bw%p_vj_slope(j), assim%p_f_leaf, assim_bw%&
&                     p_f_leaf, assim%p_kc25, assim%p_ko25, assim%&
&                     p_tau25, assim%p_sif_alpha(j), assim_bw%&
&                     p_sif_alpha(j), assim%p_sif_beta(j), assim_bw%&
&                     p_sif_beta(j), param, meteo, coszs, var_o, &
&                     var_o_bw, var_n, var_n_bw, soilp, soilp_bw, &
&                     mid_res, mid_res_bw, daylen)
          CALL POPCONTROL2B(branch)
          IF (branch .EQ. 0) THEN
            DO k=32,27,-1
...
&               var_o_bw(k)
            ...
            END DO
            DO k=40,0,-1
              CALL POPREAL8(var_o(k))
              var_o_bw(k) = 0.0_8
            END DO
            CALL POPREAL8ARRAY(soilp%temp_soil_c, r8*10/8)
            CALL INIT_SOIL_STATUS_BW(soilp, soilp_bw, bound%st(i), clim%&
&                              temp(i), bound%sw(i), bound%sdp(i))
            ii = bound%stext(i)
            DO kk=4,0,-1
              CALL POPREAL8(soilp%b(kk))
              assim_bw%p_b_scalar(ii) = assim_bw%p_b_scalar(ii) + soilp%&
&               b(kk)*soilp_bw%b(kk)
              soilp_bw%b(kk) = assim%p_b_scalar(ii)*soilp_bw%b(kk)
              CALL POPREAL8(soilp%ksat(kk))
              assim_bw%p_ksat_scalar(ii) = assim_bw%p_ksat_scalar(ii) + &
&               soilp%ksat(kk)*soilp_bw%ksat(kk)
              soilp_bw%ksat(kk) = assim%p_ksat_scalar(ii)*soilp_bw%ksat(&
&               kk)
            END DO
            CALL INIT_SOIL_PARAMETERS_BW(bound%lcno(i, j), bound%stext(i&
&                                  ), param(27), soilp, soilp_bw)
          ELSE
            IF (branch .EQ. 1) THEN
              DO k=26,21,-1
...
&                                    (i), param(27), soilp, soilp_bw)
 ...
 100    CONTINUE
        CALL POPREAL8(meteo%s_dir)
        CALL POPREAL8(meteo%s_dff)
        CALL POPCONTROL1B(branch)
        IF (branch .EQ. 0) THEN
          CALL POPREAL8(clim%temp(i))
          CALL POPCONTROL2B(branch)
          IF (branch .LT. 2) THEN
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(meteo%temp)
            ELSE
              CALL POPREAL8(meteo%temp)
            END IF
        ...
        END IF
        CALL POPCONTROL1B(branch)
        IF (branch .NE. 0) CALL POPREAL8(meteo%temp)
        CALL POPREAL8(meteo%rh)
        CALL POPREAL8(meteo%snow)
        CALL POPREAL8(meteo%rainfall)
        CALL POPREAL8(meteo%wind)
        CALL POPREAL8(meteo%srad)
        CALL POPREAL8(coszs)
      END DO
      CALL POPCONTROL2B(branch)
      CALL POPCONTROL2B(branch)
      ...
      ELSE IF (branch .EQ. 1) THEN
        CALL POPREAL8ARRAY(clim%temp, r8*SIZE(clim%temp, 1)/8)
      END IF
      CALL POPREAL8(cos_air)
      CALL POPREAL8(co2_air)
...
!  Differentiation of inter_prg in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstyp
!e bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
! Snow pack stage 1  by R.Luo
    CALL PUSHREAL8(zsp)
    CALL PUSHREAL8(rho_snow(kkk))
    CALL PUSHREAL8(ac_snow_u(kkk))
    CALL PUSHREAL8(ac_snow_o(kkk))
    CALL PUSHREAL8(wg_snow(kkk))
    CALL PUSHREAL8(wcs_u(kkk))
    CALL PUSHREAL8(wcs_o(kkk))
...
! rainfall stag 1
    CALL PUSHREAL8(wcl_u(kkk))
    CALL PUSHREAL8(wcl_o(kkk))
...
&     237.3))
    ...
    CALL PUSHREAL8(percentarea_snow_o)
    percentarea_snow_o = ac_snow_o(kkk)/lai_o/2.
    CALL PUSHREAL8(percentarea_snow_u)
...
! aerodynamic_conductance module by G.Mo
      arg1 = lai_o + stem_o
      CALL PUSHREAL8(g_u_b)
      CALL PUSHREAL8(g_u_a)
      CALL PUSHREAL8(g_o_b)
      CALL PUSHREAL8(g_o_a)
      CALL PUSHREAL8(ra_g)
...
! net Radiation at canopy and leaf level module by X.Luo
      arg1 = lai_o + stem_o
      arg2 = lai_u + stem_u
      CALL PUSHREAL8(r_u_shaded)
      CALL PUSHREAL8(r_u_sunlit)
      CALL PUSHREAL8(r_o_shaded)
      CALL PUSHREAL8(r_o_sunlit)
      CALL PUSHREAL8(radiation_u_shaded)
      CALL PUSHREAL8(radiation_u_sun)
      CALL PUSHREAL8(radiation_o_shaded)
      CALL PUSHREAL8(radiation_o_sun)
      CALL PUSHREAL8(radiation_g)
...
&       temp_air))*rho_a*cp_ca/psychrometer
      IF (coszs .GT. 0.) THEN
        CALL PUSHREAL8(lcos_o_sunlit)
        CALL PUSHREAL8(lsif_o_sunlit)
        CALL PUSHREAL8(ac_o_sunlit)
        CALL PUSHREAL8(gs_o_sunlit_new)
...
&                     cosi_o_sunlit_new, lcos_o_sunlit)
        CALL PUSHREAL8(lcos_o_shaded)
        CALL PUSHREAL8(lsif_o_shaded)
        CALL PUSHREAL8(ac_o_shaded)
        CALL PUSHREAL8(gs_o_shaded_new)
...
&                     cosi_o_shaded_new, lcos_o_shaded)
        CALL PUSHREAL8(lcos_u_sunlit)
        CALL PUSHREAL8(lsif_u_sunlit)
        CALL PUSHREAL8(ac_u_sunlit)
        CALL PUSHREAL8(gs_u_sunlit_new)
...
&                     cosi_u_sunlit_new, lcos_u_sunlit)
        CALL PUSHREAL8(lcos_u_shaded)
        CALL PUSHREAL8(lsif_u_shaded)
        CALL PUSHREAL8(ac_u_shaded)
        CALL PUSHREAL8(gs_u_shaded_new)
...
&                     cosi_u_shaded_new, lcos_u_shaded)
      ...
      END IF
!       write(*,*) G_o_b,gs_h2o
      CALL PUSHREAL8(ci_o_sunlit_old)
      ci_o_sunlit_old = ci_o_sunlit_new
      CALL PUSHREAL8(cosi_o_sunlit_old)
      cosi_o_sunlit_old = cosi_o_sunlit_new
      CALL PUSHREAL8(gs_o_sunlit_old)
...
&         abs3 .LT. 0.02) THEN
      ...
      ELSE IF (num .GT. 22) THEN
        GOTO 110
      ELSE
        CALL PUSHREAL8(tc_o_sunlit_old)
        tc_o_sunlit_old = tc_o_sunlit_new
        CALL PUSHREAL8(tc_o_shaded_old)
        tc_o_shaded_old = tc_o_shaded_new
        CALL PUSHREAL8(tc_u_sunlit_old)
        tc_u_sunlit_old = tc_u_sunlit_new
        CALL PUSHREAL8(tc_u_shaded_old)
...
! Surface temperature
    ...
    cs(1, kkk) = soilp%cs(0)
    tc_u(kkk) = tcu
    CALL PUSHREAL8(lambda_soil(1))
    lambda_soil(1) = soilp%lambda(0)
    CALL PUSHREAL8(d_soil(1))
    d_soil(1) = soilp%d_soil(0)
    CALL PUSHREAL8(tm(1, kkk-1))
    tm(1, kkk-1) = soilp%temp_soil_p(1)
    CALL PUSHREAL8(tm(0, kkk-1))
    tm(0, kkk-1) = soilp%temp_soil_p(0)
    g(1, kkk) = soilp%g(0)
    CALL PUSHREAL8(tsn2(kkk))
    CALL PUSHREAL8(tsn1(kkk))
    CALL PUSHREAL8(tsm0(kkk))
    CALL PUSHREAL8(tsn0(kkk))
    CALL PUSHREAL8(tm(0, kkk))
    CALL PUSHREAL8(ts0(kkk))
...
&                     kkk), tsn2(kkk), g(0, kkk))
    CALL PUSHREAL8(soilp%temp_soil_c(0))
...
! use the method in BETHY to calculate phenology, with a little modification, @Mousong.Wu,201905
  ...
  CALL COS_GRND_BW(soilp, soilp_bw, cos_soil, cos_soil_bw, lc)
  CALL POPCONTROL2B(branch)
  IF (branch .EQ. 0) THEN
...
&                     zp, zp_bw, wg_snow(kkk), wg_snow_bw(kkk))
    CALL POPREAL8(soilp%temp_soil_c(0))
    tm_bw(0, kkk) = tm_bw(0, kkk) + soilp_bw%temp_soil_c(0)
    soilp_bw%temp_soil_c(0) = 0.0_8
    CALL POPREAL8(ts0(kkk))
    CALL POPREAL8(tm(0, kkk))
    CALL POPREAL8(tsn0(kkk))
    CALL POPREAL8(tsm0(kkk))
    CALL POPREAL8(tsn1(kkk))
    CALL POPREAL8(tsn2(kkk))
...
&     lsif_o_sunlit*temp_bw0
    ...
    CALL POPCONTROL1B(branch)
    IF (branch .NE. 0) THEN
      CALL POPREAL8(tc_u_shaded_old)
      CALL POPREAL8(tc_u_sunlit_old)
      CALL POPREAL8(tc_o_shaded_old)
      CALL POPREAL8(tc_o_sunlit_old)
      percentarea_snow_o = ac_snow_o(kkk)/lai_o/2.
      percentarea_snow_u = ac_snow_u(kkk)/lai_u/2.
    END IF
    CALL POPINTEGER4(ad_count)
...
&       temp_bw0
      CALL POPREAL8(tc_o_sunlit_new)
      CALL POPREAL8(tc_o_shaded_new)
      CALL POPREAL8(tc_u_sunlit_new)
      CALL POPREAL8(tc_u_shaded_new)
...
&       **2
      CALL POPREAL8(gs_u_shaded_old)
      CALL POPREAL8(cosi_u_shaded_old)
      cosi_u_shaded_new_bw = cosi_u_shaded_old_bw
      CALL POPREAL8(ci_u_shaded_old)
      CALL POPREAL8(gw_u_sunlit)
      ...
      CALL POPREAL8(gs_u_sunlit_old)
      CALL POPREAL8(cosi_u_sunlit_old)
      cosi_o_sunlit_new_bw = cosi_u_sunlit_old_bw + cosi_o_sunlit_old_bw
      CALL POPREAL8(ci_u_sunlit_old)
      CALL POPREAL8(gw_o_shaded)
...
&       **2
      CALL POPREAL8(gs_o_shaded_old)
      CALL POPREAL8(cosi_o_shaded_old)
      cosi_o_shaded_new_bw = cosi_o_shaded_old_bw
      CALL POPREAL8(ci_o_shaded_old)
      CALL POPREAL8(gw_o_sunlit)
...
&       temp_bw0/gs_o_sunlit_new**2
      ...
      CALL POPREAL8(gs_o_sunlit_old)
      CALL POPREAL8(cosi_o_sunlit_old)
      CALL POPREAL8(ci_o_sunlit_old)
      CALL POPCONTROL1B(branch)
      IF (branch .EQ. 0) THEN
        CALL POPREAL8(lcos_u_shaded)
        CALL POPREAL8(lsif_u_shaded)
        CALL POPREAL8(gs_u_shaded_new)
        CALL POPREAL8(lcos_u_sunlit)
        CALL POPREAL8(lsif_u_sunlit)
        CALL POPREAL8(gs_u_sunlit_new)
        CALL POPREAL8(lcos_o_shaded)
        CALL POPREAL8(lsif_o_shaded)
        CALL POPREAL8(gs_o_shaded_new)
        CALL POPREAL8(lcos_o_sunlit)
        CALL POPREAL8(lsif_o_sunlit)
        CALL POPREAL8(gs_o_sunlit_new)
        ac_o_shaded_bw = 0.0_8
...
&       temp_bw0/psychrometer
      ...
      tco = (tc_o_sunlit_old*lai_o_sunlit+tc_o_shaded_old*lai_o_shaded)/&
&       (lai_o_sunlit+lai_o_shaded)
      CALL POPREAL8(radiation_g)
      CALL POPREAL8(radiation_o_sun)
      CALL POPREAL8(radiation_o_shaded)
      CALL POPREAL8(radiation_u_sun)
      CALL POPREAL8(radiation_u_shaded)
      CALL POPREAL8(r_o_sunlit)
      CALL POPREAL8(r_o_shaded)
      CALL POPREAL8(r_u_sunlit)
      CALL POPREAL8(r_u_shaded)
...
&       temp_bw0
      ...
      CALL POPREAL8(gww_u_sunlit)
      temp = 1.0/g_u_a + 1.0/g_u_b + 100.
      temp_bw = -(gww_u_sunlit_bw/temp**2)
      g_u_a_bw = g_u_a_bw - temp_bw/g_u_a**2
      g_u_b_bw = g_u_b_bw - temp_bw/g_u_b**2
      CALL POPREAL8(gww_o_shaded)
...
&                               g_u_a_bw, g_u_b, g_u_b_bw)
      ...
      lcos_u_sunlit_bw = 0.0_8
 150 CONTINUE
    CALL POPREAL8(percentarea_snow_u)
    ...
    CALL POPREAL8(percentarea_snow_o)
...
&                     r_rain_g(kkk), r_rain_g_bw(kkk))
    ...
    CALL POPREAL8(wcs_u(kkk))
    CALL POPREAL8(wg_snow(kkk))
    CALL POPREAL8(ac_snow_o(kkk))
    CALL POPREAL8(ac_snow_u(kkk))
    CALL POPREAL8(rho_snow(kkk))
    CALL POPREAL8(zsp)
...
!  Differentiation of aerodynamic_conductance in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypein
!it.initbepstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of cos_grnd in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype
! bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
SUBROUTINE COS_GRND_BW(soilp, soilp_bw, cos_soil, cos_soil_bw, lc)
  USE SHR_KIND_MOD, ONLY : r8 => shr_kind_r8
  USE BEPS_SOILMOD_DIFF
  IMPLICIT NONE
!Input Variables
...
! local ground COS flux (pmol/m2/sec)
  REAL(r8) :: cos_soil
  REAL(r8) :: cos_soil_bw
! add alpha, beta, depth_ratio   2023/12/16  Huajie Zhu          delete a  2024/01/18 Huajie Zhu  
  REAL(r8) :: f_opt, s_opt, f_g, s_g, alpha, beta, depth_ratio
  REAL(r8) :: f_opt_bw, f_g_bw
! add F_opt_T and F_g_T for temperature correction        2024/01/18   Huajie Zhu
  REAL(r8) :: f_opt_t, f_g_t
  REAL(r8) :: f_opt_t_bw, f_g_t_bw
...
!tely.
!   the paramerization scheme of the abiotic part was taken from Abadie et al. 2022, BG (see Table A2, and Table 2 in Whelan et a
!l, 2016, ACP for details).   
!   the paramerization scheme of the biotic part was taken from Whelan et al. 2022, JGRB (see Sect. 2.2 and Table 3 for details).
!   
!   Referring to Abadie et al. 2022 and Whelan et al. 2022, here we only calculated the COS soil flux from the top 9 cm ( Top lay
!er (5cm) + 0.4 * second layer (10cm) in BEPS)
! soil_ice  = 0.
! dsoil     = 0.
! do j = 1,3
...
! top 9 cm ( Top layer (5cm) + 0.4 * second layer (10cm) in BEPS)
  depth_ratio = 0.4
  soil_t = soilp%temp_soil_c(0)*soilp%d_soil(0) + soilp%temp_soil_c(1)*&
&   soilp%d_soil(1)*depth_ratio
! unit: ℃
  soil_t = soil_t/(soilp%d_soil(0)+soilp%d_soil(1)*depth_ratio)
  soil_s = soilp%thetam(0)*soilp%d_soil(0) + soilp%thetam(1)*soilp%&
&   d_soil(1)*depth_ratio
! unit: %
  soil_s = soil_s/(soilp%d_soil(0)+soilp%d_soil(1)*depth_ratio)*100
  SELECT CASE  (lc) 
  CASE (1) 
! conifer evergreen
    alpha = -7.77
...
! S_g  = 35.0
  IF (soil_t .GT. 0) THEN
    ...
    CASE (1) 
! conifer evergreen
! accroding to Broadleaf or needleleaf 
      s_opt = 12.5
! In whelan's COS soil model, negetive indicate COS uptake.
      f_opt = -18
      s_g = 19.3
      f_g = -5.9
! apply tempreture correction with a same model of moisture correction, here soil_T must be positive  
      CALL FLUX_AT_S(soil_t, f_opt, -12.0, 35.0, 28.0, f_opt_t)
! apply tempreture correction with a same model of moisture correction
      CALL FLUX_AT_S(soil_t, f_g, -3.8, 35.0, 28.0, f_g_t)
! apply moisture correction based on F_opt_T and F_g_T
      CALL PUSHCONTROL4B(1)
    CASE (2) 
! conifer decidous
      s_opt = 12.5
...
! note, here F_opt and F_g was used.
      CALL PUSHCONTROL4B(3)
    CASE (9) 
!  broadleaf evergreen 
      s_opt = 24.6
...
! C4 crop
  ...
  IF (branch .LT. 5) THEN
    IF (branch .LT. 2) THEN
      ...
      ELSE
        soil_s_bw = 0.0_8
        CALL FLUX_AT_S_BW(soil_s, soil_s_bw, f_opt_t, f_opt_t_bw, f_g_t&
&                   , f_g_t_bw, s_g, s_opt, cos_soil_biotic, &
&                   cos_soil_biotic_bw)
        soil_t_bw = 0.0_8
        CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_g, f_g_bw, -3.8, &
&                   dummydiff_bw0, 35.0, 28.0, f_g_t, f_g_t_bw)
        CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_opt, f_opt_bw, -12.0, &
&                   dummydiff_bw, 35.0, 28.0, f_opt_t, f_opt_t_bw)
      END IF
    ELSE IF (branch .EQ. 2) THEN
      soil_s_bw = 0.0_8
      CALL FLUX_AT_S_BW(soil_s, soil_s_bw, f_opt_t, f_opt_t_bw, f_g_t, &
...
&                 cos_soil_biotic_bw)
      soil_t_bw = 0.0_8
      CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_g, f_g_bw, -3.8, &
&                 dummydiff_bw2, 35.0, 28.0, f_g_t, f_g_t_bw)
      CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_opt, f_opt_bw, -12.0, &
&                 dummydiff_bw1, 35.0, 28.0, f_opt_t, f_opt_t_bw)
    ELSE IF (branch .EQ. 3) THEN
      soil_s_bw = 0.0_8
      CALL FLUX_AT_S_BW(soil_s, soil_s_bw, f_opt, f_opt_bw, f_g, f_g_bw&
&                 , s_g, s_opt, cos_soil_biotic, cos_soil_biotic_bw)
      soil_t_bw = -(0.18*f_g_bw)
    ELSE
      soil_s_bw = 0.0_8
      CALL FLUX_AT_S_BW(soil_s, soil_s_bw, f_opt, f_opt_bw, f_g, f_g_bw&
&                 , s_g, s_opt, cos_soil_biotic, cos_soil_biotic_bw)
...
&                 cos_soil_biotic_bw)
      soil_t_bw = 0.0_8
      CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_g, f_g_bw, -1.3, &
&                 dummydiff_bw4, 25.0, 14.8, f_g_t, f_g_t_bw)
      CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_opt, f_opt_bw, -1.5, &
&                 dummydiff_bw3, 25.0, 10.9, f_opt_t, f_opt_t_bw)
    ELSE
      soil_s_bw = 0.0_8
      CALL FLUX_AT_S_BW(soil_s, soil_s_bw, f_opt, f_opt_bw, f_g, f_g_bw&
&                 , s_g, s_opt, cos_soil_biotic, cos_soil_biotic_bw)
...
&               cos_soil_biotic_bw)
    soil_t_bw = 0.0_8
    CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_g, f_g_bw, -1.3, &
&               dummydiff_bw6, 25.0, 14.8, f_g_t, f_g_t_bw)
    CALL FLUX_AT_S_BW(soil_t, soil_t_bw, f_opt, f_opt_bw, -1.5, &
&               dummydiff_bw5, 25.0, 10.9, f_opt_t, f_opt_t_bw)
...
&               s_g, s_opt, cos_soil_biotic, cos_soil_biotic_bw)
  ...
  ELSE
    ...
    soil_t_bw = 0.0_8
  END IF
  soil_t_bw = soil_t_bw + beta*EXP(alpha+beta*soil_t)*&
&   cos_soil_abiotic_bw
  soil_s_bw = 100*soil_s_bw/(soilp%d_soil(0)+soilp%d_soil(1)*depth_ratio&
&   )
  soilp_bw%thetam(0) = soilp_bw%thetam(0) + soilp%d_soil(0)*soil_s_bw
  soilp_bw%thetam(1) = soilp_bw%thetam(1) + soilp%d_soil(1)*depth_ratio*&
&   soil_s_bw
  soil_t_bw = soil_t_bw/(soilp%d_soil(0)+soilp%d_soil(1)*depth_ratio)
  soilp_bw%temp_soil_c(0) = soilp_bw%temp_soil_c(0) + soilp%d_soil(0)*&
&   soil_t_bw
  soilp_bw%temp_soil_c(1) = soilp_bw%temp_soil_c(1) + soilp%d_soil(1)*&
&   depth_ratio*soil_t_bw
END SUBROUTINE COS_GRND_BW

!  Differentiation of flux_at_s in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstyp
!e bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: result soil_s_in
!   with respect to varying inputs: f_g_in f_opt_in soil_s_in
SUBROUTINE FLUX_AT_S_BW(soil_s_in, soil_s_in_bw, f_opt_in, f_opt_in_bw, &
& f_g_in, f_g_in_bw, s_g_in, s_opt_in, result, result_bw)
  IMPLICIT NONE
  REAL, INTENT(IN) :: soil_s_in, f_opt_in, f_g_in, s_g_in, s_opt_in
  REAL :: soil_s_in_bw, f_opt_in_bw, f_g_in_bw
  REAL :: result
  REAL :: result_bw
  REAL :: a
  REAL :: a_bw
  ...
  REAL :: temp1
  REAL :: temp_bw1
  a = LOG(f_opt_in/f_g_in)*(LOG(s_opt_in/s_g_in)+(s_g_in/s_opt_in-1.))**&
&   (-1)
  temp = soil_s_in/s_opt_in - 1
  temp0 = soil_s_in/s_opt_in
  temp1 = temp0**a
  temp_bw0 = EXP(-(a*temp))*result_bw
  temp_bw1 = EXP(-(a*temp))*f_opt_in*temp1*result_bw
  IF (temp0 .LE. 0.0_8) THEN
    a_bw = -(temp*temp_bw1)
  ELSE
    a_bw = temp1*LOG(temp0)*f_opt_in*temp_bw0 - temp*temp_bw1
  END IF
  IF (temp0 .LE. 0.0_8 .AND. (a .EQ. 0.0_8 .OR. a .NE. INT(a))) THEN
    soil_s_in_bw = soil_s_in_bw - a*temp_bw1/s_opt_in
  ELSE
    soil_s_in_bw = soil_s_in_bw + a*temp0**(a-1)*f_opt_in*temp_bw0/&
&     s_opt_in - a*temp_bw1/s_opt_in
  END IF
  temp_bw = a_bw/(f_opt_in*(LOG(s_opt_in/s_g_in)+s_g_in/s_opt_in-1.))
  f_opt_in_bw = temp1*temp_bw0 + temp_bw
  f_g_in_bw = -(f_opt_in*temp_bw/f_g_in)
END SUBROUTINE FLUX_AT_S_BW

!  Differentiation of beps_phenology in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbe
!pstype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of netradiation in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbeps
!type bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of sensibleheat in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbeps
!type bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
!   gradient     of useful results: lai_o_sunlit templ_o_sunlit
...
!  Differentiation of retrive_soilp in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbep
!stype bepstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!  Differentiation of x2beps in reverse (adjoint) mode (with options noinclude noISIZE r8 split(initf bepstypeinit.initbepstype b
!epstypeinit.initsoilstat bepstypeinit.initouput bepstypeinit.initassim)):
...
!
  IF (nscale .NE. 1) THEN
    WRITE(*, '(a,(a,1x,i10))') ' FATAL::'//sub//&
&   ':setup was *NOT* set for site-level/multi-point experiment!', &
&   ' nscale=', nscale
    STOP
  ELSE IF (meteo_input .LT. 0) THEN
...
&   //' is supported.'
  ...
  ELSE IF (lai_input .LT. 0) THEN
    WRITE(*, '(a)') ' FATAL::'//sub//&
&   ':LAI is expected to be forcing input.'
    STOP
  ELSE IF (m .NE. nsimvar*npoints*ntp) THEN
!-- size consistency of target vector
    WRITE(*, '(a,2(a,i6,1x))') ' FATAL::'//sub//&
&   ':inconsistent sizes detected! ', 'expected m=', m, &
...
! & Forest Ecology and Management, @Mousong.Wu, 201905
! add lc,  @Huajie Zhu,20231217
  CALL COS_GRND_CD(soilp, cos_soil, lc)
! pmol/m2/s
  mid_res%cos_grnd = cos_soil
  RETURN
END SUBROUTINE INTER_PRG_CD

SUBROUTINE COS_GRND_CD(soilp, cos_soil, lc)
  USE SHR_KIND_MOD, ONLY : r8 => shr_kind_r8
  USE BEPS_SOILMOD_DIFF
  IMPLICIT NONE
!Input Variables
...
! C4 crop
  ...
  ELSE
    cos_soil_biotic = 0
  END IF
! In our model, positive indicate COS uptake                  
...
!> \date    May 2024
!> \last    May 2024
SUBROUTINE GET_NLAI_CD(yr, mn, dy, tod, n_lai)
  USE SHR_KIND_MOD, ONLY : r8 => shr_kind_r8
  USE BEPS_TIME_MANAGER, ONLY : timemgr_datediff
  USE CONTROLINPUT_MOD_DIFF, ONLY : read_lai_site_reftime
  USE BEPSTYPE_DIFF, ONLY : bound
  IMPLICIT NONE
!-- arguments
  INTEGER, INTENT(IN) :: yr, mn, dy, tod
...
!   (yr,mn,dy,tod) - (lai_yr,lai_mn,lai_dy,0)
  arg1 = lai_yr*10000 + lai_mn*100 + lai_dy
  arg2 = yr*10000 + mn*100 + dy
  CALL TIMEMGR_DATEDIFF(arg1, 0, arg2, tod, days_lai)
!-- convert to integer
