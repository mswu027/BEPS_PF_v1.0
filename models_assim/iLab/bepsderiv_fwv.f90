...
!
!  Differentiation of cos_plant in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of fominef_ss in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of maxx in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
CONTAINS
!  Differentiation of initbepstype in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of initassim in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of initsoilstat in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of initouput in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
CONTAINS
!  Differentiation of meteo_pack in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
CONTAINS
!  Differentiation of lai_cal in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of vcmax_jmax in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of leaf_temperatures in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of leaf_temperature in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of transpiration in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of evaporation_canopy in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of photosynthesis in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of sfc_vpd in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of temp_func in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: y
...
!  Differentiation of lambda in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: y
...
!  Differentiation of tboltz in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: y
!   with respect to varying inputs: rate
...
!  Differentiation of tboltzc4 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: y
!   with respect to varying inputs: rate
...
CONTAINS
!  Differentiation of init_soil_parameters in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of init_soil_status in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of surfacetemperature in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of updateheatflux in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of update_cs in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of update_ice_ratio in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of updatesoilthermalconductivity in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional
!):
...
!  Differentiation of updatesoilmoisture in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of soil_water_uptake in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of soil_water_factor_v2 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of soil_evaporation in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
CONTAINS
!  Differentiation of rainfall_stage1 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of rainfall_stage2 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of snowpack_stage1 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of snowpack_stage2 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of snowpack_stage3 in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
CONTAINS
!  Differentiation of restart_io in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: *v2last
!   with respect to varying inputs: *v2last
!   Plus diff mem management of: v2last:in
  SUBROUTINE RESTART_IO_FWV(flag, yy, mm, dd, tod, nbdirs)
    USE DIFFSIZES
!  Hint: nbdirsmax should be the maximum number of differentiation directions
    IMPLICIT NONE
    CHARACTER(len=*) :: flag
...
!  Differentiation of cost in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!                fact.latent[from module angsmod]:(loc) f:out x:in
...
!  Differentiation of misfit in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!> \authors Michael Vossbeck, The Inversion Lab
!> \date    June 2022
SUBROUTINE NCWRITEOBS_CDV(m, yobs, syobs)
  USE OBS_NETCDF
  USE MO_BEPSFUNC_CTL
  USE BEPSTYPE_DIFFV, ONLY : bound
...
END SUBROUTINE NCWRITEOBS_CDV

!  Differentiation of devprior in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of evalf_wrapper in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: cost
!   with respect to varying inputs: pert
!   RW status of diff variables: e_actual[from module meteomod]:(loc)
!                cp_air[from module meteomod]:(loc) e_saturate[from module meteomod]:(loc)
!                sp_humidity[from module meteomod]:(loc) vpd[from module meteomod]:(loc)
!                slope_vapor[from module meteomod]:(loc) bound_layer_res.vapor[from module angsmod]:(loc)
!                fact.latent[from module angsmod]:(loc) pert:in
!                cost:out
...
!  Differentiation of initf in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   Plus diff mem management of: v2last:out assim.p_vcmax:out assim.p_vj_slope:out
!                assim.p_sif_alpha:out assim.p_sif_beta:out assim.p_ksat_scalar:out
!                assim.p_b_scalar:out assim.p_f_leaf:out soilstat.zp:out
!                soilstat.zsp:out soilstat.r_rain_g:out soilstat.r_drainage:out
...
!  Differentiation of evalf in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: y
!   with respect to varying inputs: x
...
!-- map actual control vector to model parameters
    ...
    jcnt = 1
    IF (ALLOCATED(v2last_fw)) v2last_fw = 0.0_8
    output_fw%sifpft = 0.0_8
    output_fw%sif = 0.0_8
    output_fw%thetampft = 0.0_8
    output_fw%thetam = 0.0_8
    output_fw%cos_fluxpft = 0.0_8
    output_fw%cos_flux = 0.0_8
    y_fw = 0.0_8
    var_n_fw = 0.0_8
    var_o_fw = 0.0_8
...
!         (tod will be zero, except the simulation had been started subdaily)
            CALL GET_NLAI_CDV(yr, mn, dy, tod, n_lai)
...
!! write out data and restart fields
      IF (enable_netcdf_out) THEN
        arg10 = nd + 1
        CALL AV_OUTPUT(yr, mn, dy, tod, arg10, is_end_curr_month, &
...
!  Differentiation of inter_prg in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
! add lc,  @Huajie Zhu,20231217
  CALL COS_GRND_FWV(soilp, soilp_fw, cos_soil, cos_soil_fw, lc, nbdirs)
! pmol/m2/s
  DO nd=1,nbdirs
...
!  Differentiation of aerodynamic_conductance in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of cos_grnd in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: cos_soil
!   with respect to varying inputs: soilp.thetam soilp.temp_soil_c
SUBROUTINE COS_GRND_FWV(soilp, soilp_fw, cos_soil, cos_soil_fw, lc, &
& nbdirs)
  USE SHR_KIND_MOD, ONLY : r8 => shr_kind_r8
  USE BEPS_SOILMOD_DIFFV
  USE DIFFSIZES
...
& cos_soil_biotic_fw
  ...
  INTEGER :: nd
  REAL(r8) :: temp
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw0
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw1
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw2
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw3
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw4
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw5
  REAL, DIMENSION(nbdirsmax) :: dummyzerodiff_fw6
  INTEGER :: nbdirs
...
! top 9 cm ( Top layer (5cm) + 0.4 * second layer (10cm) in BEPS)
  depth_ratio = 0.4
! unit: ℃
  temp = soilp%d_soil(0) + soilp%d_soil(1)*depth_ratio
  DO nd=1,nbdirs
    soil_t_fw(nd) = soilp%d_soil(0)*soilp_fw%temp_soil_c(nd, 0) + soilp%&
&     d_soil(1)*depth_ratio*soilp_fw%temp_soil_c(nd, 1)
    soil_t_fw(nd) = soil_t_fw(nd)/temp
    soil_s_fw(nd) = soilp%d_soil(0)*soilp_fw%thetam(nd, 0) + soilp%&
&     d_soil(1)*depth_ratio*soilp_fw%thetam(nd, 1)
  END DO
...
! unit: %
  temp = soilp%d_soil(0) + soilp%d_soil(1)*depth_ratio
  DO nd=1,nbdirs
    soil_s_fw(nd) = 100*soil_s_fw(nd)/temp
  END DO
  soil_s = 100*(soil_s/temp)
  SELECT CASE  (lc) 
  CASE (1) 
! conifer evergreen
    alpha = -7.77
...
! C4 crop
    ...
    beta = 0.108
  END SELECT
  arg1 = alpha + beta*soil_t
  DO nd=1,nbdirs
    arg1_fw(nd) = beta*soil_t_fw(nd)
    cos_soil_abiotic_fw(nd) = EXP(arg1)*arg1_fw(nd)
  END DO
  cos_soil_abiotic = EXP(arg1)
...
! apply tempreture correction with a same model of moisture correction, here soil_T must be positive  
      f_opt_fw = 0.0_8
      dummyzerodiff_fw = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_opt, f_opt_fw, -12.0, &
&                  dummyzerodiff_fw, 35.0, 28.0, f_opt_t, f_opt_t_fw, &
&                  nbdirs)
! apply tempreture correction with a same model of moisture correction
      f_g_fw = 0.0_8
      dummyzerodiff_fw0 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_g, f_g_fw, -3.8, &
&                  dummyzerodiff_fw0, 35.0, 28.0, f_g_t, f_g_t_fw, &
&                  nbdirs)
! apply moisture correction based on F_opt_T and F_g_T
      CALL FLUX_AT_S_FWV(soil_s, soil_s_fw, f_opt_t, f_opt_t_fw, f_g_t, &
&                  f_g_t_fw, s_g, s_opt, cos_soil_biotic, &
&                  cos_soil_biotic_fw, nbdirs)
    CASE (2) 
! conifer decidous
      s_opt = 12.5
      f_opt = -18
      ...
      f_g = -5.9
      f_opt_fw = 0.0_8
      dummyzerodiff_fw1 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_opt, f_opt_fw, -12.0, &
&                  dummyzerodiff_fw1, 35.0, 28.0, f_opt_t, f_opt_t_fw, &
&                  nbdirs)
      f_g_fw = 0.0_8
      dummyzerodiff_fw2 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_g, f_g_fw, -3.8, &
&                  dummyzerodiff_fw2, 35.0, 28.0, f_g_t, f_g_t_fw, &
&                  nbdirs)
      CALL FLUX_AT_S_FWV(soil_s, soil_s_fw, f_opt_t, f_opt_t_fw, f_g_t, &
&                  f_g_t_fw, s_g, s_opt, cos_soil_biotic, &
&                  cos_soil_biotic_fw, nbdirs)
...
! broadleaf decidous
      ...
      s_g = 51
      DO nd=1,nbdirs
        f_g_fw(nd) = -(0.18*soil_t_fw(nd))
      END DO
      f_g = -(0.18*soil_t) + 0.48
! note, here F_opt and F_g was used.
      f_opt_fw = 0.0_8
      CALL FLUX_AT_S_FWV(soil_s, soil_s_fw, f_opt, f_opt_fw, f_g, f_g_fw&
&                  , s_g, s_opt, cos_soil_biotic, cos_soil_biotic_fw, &
&                  nbdirs)
    CASE (9) 
!  broadleaf evergreen 
      s_opt = 24.6
...
! grass
      ...
      f_g = -2.3
      f_opt_fw = 0.0_8
      dummyzerodiff_fw3 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_opt, f_opt_fw, -1.5, &
&                  dummyzerodiff_fw3, 25.0, 10.9, f_opt_t, f_opt_t_fw, &
&                  nbdirs)
      f_g_fw = 0.0_8
      dummyzerodiff_fw4 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_g, f_g_fw, -1.3, &
&                  dummyzerodiff_fw4, 25.0, 14.8, f_g_t, f_g_t_fw, &
&                  nbdirs)
      CALL FLUX_AT_S_FWV(soil_s, soil_s_fw, f_opt_t, f_opt_t_fw, f_g_t, &
&                  f_g_t_fw, s_g, s_opt, cos_soil_biotic, &
&                  cos_soil_biotic_fw, nbdirs)
...
! C4 grass
      ...
      f_g = -2.3
      f_opt_fw = 0.0_8
      dummyzerodiff_fw5 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_opt, f_opt_fw, -1.5, &
&                  dummyzerodiff_fw5, 25.0, 10.9, f_opt_t, f_opt_t_fw, &
&                  nbdirs)
      f_g_fw = 0.0_8
      dummyzerodiff_fw6 = 0.0_8
      CALL FLUX_AT_S_FWV(soil_t, soil_t_fw, f_g, f_g_fw, -1.3, &
&                  dummyzerodiff_fw6, 25.0, 14.8, f_g_t, f_g_t_fw, &
&                  nbdirs)
      CALL FLUX_AT_S_FWV(soil_s, soil_s_fw, f_opt_t, f_opt_t_fw, f_g_t, &
&                  f_g_t_fw, s_g, s_opt, cos_soil_biotic, &
&                  cos_soil_biotic_fw, nbdirs)
...
!  Differentiation of flux_at_s in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
!   variations   of useful results: result
!   with respect to varying inputs: f_g_in f_opt_in soil_s_in
SUBROUTINE FLUX_AT_S_FWV(soil_s_in, soil_s_in_fw, f_opt_in, f_opt_in_fw&
& , f_g_in, f_g_in_fw, s_g_in, s_opt_in, result, result_fw, nbdirs)
  USE DIFFSIZES
!  Hint: nbdirsmax should be the maximum number of differentiation directions
  IMPLICIT NONE
  REAL, INTENT(IN) :: soil_s_in, f_opt_in, f_g_in, s_g_in, s_opt_in
  REAL, DIMENSION(nbdirsmax), INTENT(IN) :: soil_s_in_fw, f_opt_in_fw, &
& f_g_in_fw
  REAL, INTENT(OUT) :: result
  REAL, DIMENSION(nbdirsmax), INTENT(OUT) :: result_fw
  REAL :: a
  REAL, DIMENSION(nbdirsmax) :: a_fw
  INTRINSIC LOG
  INTRINSIC EXP
  REAL :: arg1
  REAL, DIMENSION(nbdirsmax) :: arg1_fw
  ...
  REAL :: temp
  REAL :: temp0
  REAL, DIMENSION(nbdirsmax) :: temp_fw
  REAL :: temp1
  INTEGER :: nbdirs
  arg1 = f_opt_in/f_g_in
  arg2 = s_opt_in/s_g_in
  temp = LOG(arg2) + s_g_in/s_opt_in - 1.
  a = LOG(arg1)/temp
  temp1 = soil_s_in/s_opt_in
  temp0 = temp1**a
  DO nd=1,nbdirs
    arg1_fw(nd) = (f_opt_in_fw(nd)-f_opt_in*f_g_in_fw(nd)/f_g_in)/f_g_in
    a_fw(nd) = arg1_fw(nd)/(temp*arg1)
    IF (temp1 .LE. 0.0_8 .AND. (a .EQ. 0.0_8 .OR. a .NE. INT(a))) THEN
      temp_fw(nd) = 0.0_8
    ELSE IF (temp1 .LE. 0.0_8) THEN
      temp_fw(nd) = a*temp1**(a-1)*soil_s_in_fw(nd)/s_opt_in
    ELSE
      temp_fw(nd) = a*temp1**(a-1)*soil_s_in_fw(nd)/s_opt_in + temp0*LOG&
&       (temp1)*a_fw(nd)
    END IF
  END DO
  temp = soil_s_in/s_opt_in - 1
  DO nd=1,nbdirs
    arg1_fw(nd) = -(temp*a_fw(nd)+a*soil_s_in_fw(nd)/s_opt_in)
  END DO
  arg1 = -(a*temp)
  temp = EXP(arg1)
  DO nd=1,nbdirs
    result_fw(nd) = f_opt_in*temp*temp_fw(nd) + temp0*(temp*f_opt_in_fw(&
&     nd)+f_opt_in*EXP(arg1)*arg1_fw(nd))
  END DO
  result = temp0*(f_opt_in*temp)
END SUBROUTINE FLUX_AT_S_FWV

!  Differentiation of beps_phenology in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of netradiation in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of sensibleheat in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of retrive_soilp in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
!  Differentiation of x2beps in forward (tangent) mode (with options noinclude noISIZE r8 multiDirectional):
...
! & Forest Ecology and Management, @Mousong.Wu, 201905
! add lc,  @Huajie Zhu,20231217
  CALL COS_GRND_CDV(soilp, cos_soil, lc)
! pmol/m2/s
  mid_res%cos_grnd = cos_soil
  RETURN
END SUBROUTINE INTER_PRG_CDV

SUBROUTINE COS_GRND_CDV(soilp, cos_soil, lc)
  USE SHR_KIND_MOD, ONLY : r8 => shr_kind_r8
  USE BEPS_SOILMOD_DIFFV
  IMPLICIT NONE
!Input Variables
...
!> \date    May 2024
!> \last    May 2024
SUBROUTINE GET_NLAI_CDV(yr, mn, dy, tod, n_lai)
  USE SHR_KIND_MOD, ONLY : r8 => shr_kind_r8
  USE BEPS_TIME_MANAGER, ONLY : timemgr_datediff
  USE CONTROLINPUT_MOD_DIFFV, ONLY : read_lai_site_reftime
  USE BEPSTYPE_DIFFV, ONLY : bound
  IMPLICIT NONE
!-- arguments
  INTEGER, INTENT(IN) :: yr, mn, dy, tod
