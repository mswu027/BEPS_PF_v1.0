...
ifeq ($(PLATFORM),iLab)
  ifeq ($(FC),gfortran)
    LIB_NETCDF := /public1/soft/netcdf/4.4.1-gcc-szf
    INC_NETCDF := /public1/soft/netcdf/4.4.1-gcc-szf/include
    MOD_NETCDF := /public1/soft/netcdf/4.4.1-gcc-szf/include
  ...
  MPIDIR     := /public1/soft/mpich/1.2.1/
